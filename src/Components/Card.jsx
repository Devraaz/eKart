...
const Card = (props) => {
  ...
  return (
    <>
      <div className="card mx-auto flex h-[318px] w-[164px] flex-col items-center justify-between rounded-lg border border-slate-300 p-1 hover:shadow-lg sm:h-[440px] sm:w-[250px]">
        ...
        <div className="w-full space-y-1 p-2">
          ...
          {/* <div className="text-md flex w-full flex-row justify-center text-yellow-400 sm:text-lg">
            <AiFillStar />
            <AiFillStar />
            <AiFillStar />
            <AiFillStar />
